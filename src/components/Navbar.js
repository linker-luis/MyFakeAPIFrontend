    ...
    return (
        <nav className = 'relative w-full  h-16 bg-blue-700 shadow-md'>
            <div className = 'h-full z-50 m-auto flex justify-between items-center w-11/12 sm:w-10/12'>
                ...
                <ul className = {`absolute trans z-50 right-0 overflow-hidden ${toggle ? 'w-full' : 'w-0'} top-16 h-[50vh] w-screen bg-blue-700 flex flex-col justify-center items-center sm:static sm:space-x-20 sm:bg-transparent sm:w-auto sm:h-auto sm:flex-row`}>
